...
internal class CustomerEntityTypeConfiguration : IEntityTypeConfiguration<Customer>
{
    public void Configure(EntityTypeBuilder<Customer> builder)
    {
        ...
        builder.Property(x => x.Categories).HasField("_categories").HasConversion<char[]>().HasColumnName("categories");
...
internal class VehicleEntityTypeConfiguration : IEntityTypeConfiguration<Vehicle>
{
    public void Configure(EntityTypeBuilder<Vehicle> builder)
    {
        ...
        builder.OwnsOne(x => x.Category,
            cfg => cfg.Property(x => x.Character).HasColumnName("category").HasMaxLength(1).IsRequired());
    }
}

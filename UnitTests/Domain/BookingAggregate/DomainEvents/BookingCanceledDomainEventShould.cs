...
[TestSubject(typeof(BookingCanceledDomainEvent))]
public class BookingCanceledDomainEventShould
{
    ...
    public void CreateNewInstanceWithCorrectValues()
    {
        ...
        // Act
        var actual = new BookingCanceledDomainEvent(_bookingId, _vehicleId, _customerId);
    ...
    public void ThrowValueIsRequiredExceptionIfBookingIdIsEmpty()
    {
        ...
        void Act()
        {
            new BookingCanceledDomainEvent(Guid.Empty, _vehicleId, _customerId);
        }
    ...
    public void ThrowValueIsRequiredExceptionIfVehicleIdIsEmpty()
    {
        ...
        void Act()
        {
            new BookingCanceledDomainEvent(_bookingId, Guid.Empty, _customerId);
        }
    ...
    public void ThrowValueIsRequiredExceptionIfCustomerIdIsEmpty()
    {
        ...
        void Act()
        {
            new BookingCanceledDomainEvent(_bookingId, _vehicleId, Guid.Empty);
        }

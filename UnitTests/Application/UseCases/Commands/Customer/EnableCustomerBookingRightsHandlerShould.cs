...
using Application.UseCases.Commands.Customer.EnableCustomerBookingRights;
...
[TestSubject(typeof(EnableCustomerBookingRightsHandler))]
public class EnableCustomerBookingRightsHandlerShould
{
    ...
    private readonly EnableCustomerBookingRightsCommand _command = new(Guid.NewGuid());
    
    private readonly EnableCustomerBookingRightsHandler _handler;

    public EnableCustomerBookingRightsHandlerShould()
    {
        ...
        _handler = new EnableCustomerBookingRightsHandler(_customerRepositoryMock.Object, _unitOfWorkMock.Object);
    }
